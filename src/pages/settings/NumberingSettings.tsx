  ...
  useEffect(() => {
    if (settings) {
      setNumberingData({
        ...
        quantity_column_label: settings.quantity_column_label || "QTY"
      });
    }
  }, [settings]);
      ...
      <SheetContent className="w-full">
        ...
        <SheetBody>
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-medium mb-4">Credit Note Settings</h3>
              <div className="space-y-4">
                <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    id="quantityLabel"
                    value={numberingData.quantity_column_label}
                    onChange={(e) => handleChange('quantity_column_label', e.target.value)}
                    placeholder="QTY"
                  />
                </div>
              </div>
